...
export const LoginPage = () => {
  ...
  return (
    <div className="relative w-full h-screen flex items-center justify-center bg-[#050505] overflow-hidden font-sans">
      ...
      <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-150 h-150 bg-indigo-600/20 rounded-full blur-[120px] pointer-events-none" />
      ...
      <div className="relative z-10 w-full max-w-md p-10 bg-white/2 border border-white/5 rounded-3xl backdrop-blur-2xl shadow-2xl">
        <div className="mb-10 text-center">
          <div className="w-14 h-14 mx-auto mb-6 rounded-2xl bg-linear-to-br from-indigo-500 to-purple-600 flex items-center justify-center shadow-[0_0_30px_rgba(99,102,241,0.3)]">
          ...
          <p className="text-sm text-gray-400 mt-3">Sign in to your EventFlux dashboard</p>
        </div>
        ...
        <form onSubmit={handleSubmit} className="space-y-5">
          <div className="space-y-2">
            ...
            <input
              ...
              className="w-full bg-black/40 border border-white/10 rounded-xl px-5 py-4 text-sm text-white focus:border-indigo-500 focus:ring-1 focus:ring-indigo-500 focus:outline-none transition-all"
        ...
        <p className="mt-8 text-center text-sm text-gray-500 font-medium">
          Don't have an account? <Link to="/register" className="text-white hover:text-indigo-400 transition-colors">Sign up</Link>
        </p>
      </div>
    </div>
  );
