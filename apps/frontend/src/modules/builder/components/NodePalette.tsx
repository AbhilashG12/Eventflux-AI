    ...
    <div className="w-64 bg-black/20 backdrop-blur-xl border-r border-white/8 h-full flex flex-col z-10">
      ...
      <div className="p-4 space-y-4">
        ...
        <div>
          ...
          <div 
            className="bg-[#0a0a0a] border border-border rounded-lg p-3 cursor-grab hover:border-emerald-500/50 hover:bg-emerald-500/10 transition-all flex items-center gap-3"
            onDragStart={(e) => onDragStart(e, 'action', 'webhook_trigger', 'Webhook Trigger')}
            draggable
          >
        ...
        <div>
          ...
          <div 
            className="bg-[#0a0a0a] border border-border rounded-lg p-3 mb-2 cursor-grab hover:border-purple-500/50 hover:bg-purple-500/10 transition-all flex items-center gap-3"
          ...
          <div 
            className="bg-[#0a0a0a] border border-border rounded-lg p-3 cursor-grab hover:border-blue-500/50 hover:bg-blue-500/10 transition-all flex items-center gap-3"
